...
class SellerController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('/seller/dashboard', compact('sparepart', 'orderlist', 'ordercount', 'sparepartcount'));
    }
    ...
    public function sparepartEditForm($id)
    {
        $iduser = auth()->id();
        $sparepart = DB::select(
            DB::raw("SELECT s.id as idsparepart, s.partnumber, s.partname, s.unitprice, s.stock, s.description, s.vehiclemodel, s.buildyear, s.colour, s.condition, s.shops_id, s.brand, c.id as idcategories, c.categoriname
