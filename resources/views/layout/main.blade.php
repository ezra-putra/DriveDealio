...
<body class="horizontal-layout horizontal-menu content-detached-left-sidebar navbar-floating footer-static  "
    ...
    <!-- BEGIN: Header-->
    <nav class="header-navbar navbar-expand-lg navbar navbar-fixed align-items-right navbar-shadow navbar-brand-right"
        data-nav="brand-right">
                ...
                <div class="navbar-container main-menu-content" data-menu="menu-container">
                    ...
                    <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                        <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="/" data-bs-toggle=""
                                data-i18n="Analytics"><i class="fa fa-home"></i><span data-i18n="Analytics">Home</span></a></li>
                        <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="/" data-bs-toggle=""
                                data-i18n="Analytics"><i class="fa fa-car"></i><span data-i18n="Analytics">Cars</span></a></li>
                        <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="/" data-bs-toggle=""
                                data-i18n="Analytics"><i class="fa fa-motorcycle"></i><span
                                    data-i18n="Analytics">Motorcycles</span></a></li>
                        <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="/" data-bs-toggle=""
                                data-i18n="Analytics"><i class="fa fa-cogs"></i><span data-i18n="Analytics">Spareparts</span></a>
                        </li>
                        <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="/" data-bs-toggle=""
                                data-i18n="Analytics"><i class="fa fa-gavel"></i><span data-i18n="Analytics">Auctions</span></a>
                        </li>
                        <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="/" data-bs-toggle=""
                                data-i18n="Analytics"><i class="fa fa-id-card-o"></i><span
        ...
        <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border container-xxl"
            ...
            <div class="navbar-container main-menu-content" data-menu="menu-container">
                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="/"
                            data-bs-toggle="" data-i18n="Analytics"><i class="fa fa-motorcycle"></i><span
                                data-i18n="Analytics">Motorcycles</span></a></li>
                    <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="/"
                            data-bs-toggle="" data-i18n="Analytics"><i class="fa fa-cogs"></i><span
                                data-i18n="Analytics">Spareparts</span></a></li>
                    <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="/"
                            data-bs-toggle="" data-i18n="Analytics"><i class="fa fa-gavel"></i><span
                                data-i18n="Analytics">Auctions</span></a></li>
                    <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="/"
